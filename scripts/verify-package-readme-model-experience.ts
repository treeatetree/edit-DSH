...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-plugin-marketplace': { kind: 'none', reason: 'Browser-side marketplace projection; registers nothing model-facing.' },
  ...
  'packages/host/plugin-marketplace': { kind: 'none', reason: 'Host-side GitHub catalog and dsh plugin mutations; registers nothing model-facing.' },
