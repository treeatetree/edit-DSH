...
export const zh = {
  ...
  install: '安装',
  installing: '正在安装…',
  installHint: '正在运行 pnpm（GitHub 规格会先下载归档再装依赖）。冷 store 可能需要几分钟，结束前不会显示命令输出。',
  remove: '卸载',
  removing: '正在卸载…',
  browse: '在 GitHub 打开',
  customSpec: '按规格安装',
  ...
  dismissNotice: '关闭提示',
  pnpmMissing: '主机未安装 pnpm，无法安装或卸载插件。',
  sourceFailed: '目录来源失败',
  stars: '星标',
  forks: 'Fork',
  owner: '所有者',
...
export const en = {
  ...
  installHint: 'Running pnpm (a GitHub spec downloads the archive, then installs dependencies). A cold store can take several minutes, and this page does not stream command output until it finishes.',
  remove: 'Remove',
  removing: 'Removing…',
  ...
  pnpmMissing: 'pnpm is not installed on the Host, so plugins cannot be installed or removed.',
