...
The Host half registers `ui-onboarding` in the user-settings seam. The shell itself remains policy-free; default product onboarding occupancy is owned by feature packages.
