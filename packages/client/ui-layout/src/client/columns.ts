...
/** Viewport width below which the desktop shell auto-collapses the sidebar to
 * the rail (deepsuite LG breakpoint); a manual toggle below it re-expands
 * over the squeezed center (stores.ts narrowExpanded). Compact/split shells
 * are resolved in shell-mode.ts before this breakpoint applies. */
